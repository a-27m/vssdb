========================================================================
    ACTIVEX CONTROL DLL : LabActive Project Overview
========================================================================

ControlWizard has created this project for your LabActive ActiveX Control
...
that make up your LabActive ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CLabActiveCtrl control:

LabActiveCtrl.h
    This file contains the declaration of the CLabActiveCtrl C++ class.

LabActiveCtrl.cpp
    This file contains the implementation of the CLabActiveCtrl C++ class.

LabActivePropPage.h
    This file contains the declaration of the CLabActivePropPage C++ class.

LabActivePropPage.cpp
    This file contains the implementation of the CLabActivePropPage C++ class.

CLabActiveCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CLabActiveCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file LabActive.rc.
...
stdafx.h, stdafx.cpp
    ...
    named LabActive.pch and a precompiled types (PCT) file named stdafx.obj.
