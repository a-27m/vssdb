...
select Orders.EmployeeID, Employees.LastName, Employees.FirstName, SUM(Subtotal) as Total
from Employees inner join (
		Orders inner join [Order Subtotals]
			on Orders.OrderID = [Order Subtotals].OrderID)
	 on Employees.EmployeeID = Orders.EmployeeID
where Orders.OrderDate between '1996-06-01 00:00:00' and '1996-08-31 23:59:59'
