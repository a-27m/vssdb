...
(
	...
	-- ? добавить виновных, действия в случае возникновения, ссылка на список оповещения...
)
...
/*
Хранимая процедура при "запланировании" рейса добавляет нумерованные свободные места.
*/
create table Place
(
