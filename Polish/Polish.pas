unit Polish;
interface
uses SysUtils,Stack, Math;

type TTabDyxtr = array[1..6,1..8] of byte;
     TTabFuns  = array[1..26,0..1] of string;
     TParams   = array[0..27] of string;
     TVals     =  array[0..27] of Extended;

const TabFuns:TTabFuns = (  ('arcsinh','A'),('arccosh','B'),('arctanh','C'),
...
function PosCh(ch:char;cha:TParams):integer;
...
begin
result:=0;
for i:=0 to 27 do if ch=cha[i] then result:=i;
end;
