========================================================================
    ACTIVEX CONTROL DLL : actix Project Overview
========================================================================

ControlWizard has created this project for your actix ActiveX Control
...
that make up your actix ActiveX Control DLL.
...
actixCtrl.h
    This file contains the declaration of the CactixCtrl C++ class.

actixCtrl.cpp
    This file contains the implementation of the CactixCtrl C++ class.

actixPropPage.h
    This file contains the declaration of the CactixPropPage C++ class.

actixPropPage.cpp
    This file contains the implementation of the CactixPropPage C++ class.

CactixCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CactixCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file actix.rc.
...
stdafx.h, stdafx.cpp
    ...
    named actix.pch and a precompiled types (PCT) file named stdafx.obj.
